...
{
    /// <summary>
    /// OtherActivities Controller
    /// </summary>
    public class OtherActivitiesController : AdminController<OtherActivityDTO, OtherActivity>
    {
        /// <summary>
        /// The _manager
        /// </summary>
        ...
        public ViewResult Index(string currentFilter, string searchString, int? page)
        {
            ...
            IPagedList<OtherActivityDTO> otherActivities;
            if (!string.IsNullOrEmpty(searchString))
            {
                otherActivities = _manager
                    .GetAll(OtherActivitySpecification.FilterByName(searchString), d => d.Name)
