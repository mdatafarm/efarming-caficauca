...
using EFarming.Web.Areas.Admin.Controllers;
...
namespace EFarming.Web.Dependency
{
    public class DependencyConventions : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            container.Register(
                        ...
                        Component.For<IChecklistRepository, ChecklistRepository>().ImplementedBy<ChecklistRepository>().LifestylePerWebRequest(),
                        ...
                        Component.For<IQualityProfileManager, QualityProfileManager>().ImplementedBy<QualityProfileManager>().LifestylePerWebRequest(),
                        ...
                        Component.For<IChecklistManager, ChecklistManager>().ImplementedBy<ChecklistManager>().LifestylePerWebRequest(),
